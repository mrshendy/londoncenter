        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ trans('settings_trans.courses_settings') }}</h5>
                    {{-- Message --}}
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('courses_details_settings.update', 'test') }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="duration_ar"
                                                            name="duration_ar"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="duration_en"
                                                            name="duration_en"
                                        ...
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body text-center p-5">
                                                ...
                                                <div class="mt-4 pt-4">
                                                    ...
                                                    <form action="{{ route('courses_details_settings.destroy', 'test') }}"
                                                        method="post">
                                                        {{ method_field('delete') }}
                                                        {{ csrf_field() }}
                                                        <input class="form-control" id="id" name="id"
            ...
            <div class="modal-content border-0 overflow-hidden">
                ...
                <div class="modal-body">
                    <form action="{{ route('courses_details_settings.store') }}" method="post"
                        ...
                        <div class="mb-3">
                            <label for="ForminputState" class="form-label">{{ trans('settings_trans.place') }}</label>
                            <select name="place_id" class="form-control SlectBox">
                                <!--placeholder-->
                                <option value="" selected disabled>{{ trans('settings_trans.place_select') }}
                                </option>
