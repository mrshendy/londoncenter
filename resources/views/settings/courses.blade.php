        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ route('courses_settings.create') }}"
                        class="btn btn-primary waves-effect waves-light">{{ trans('settings_trans.add') }}</a>
                </div>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a href="{{ route('courses_details_settings.show', ['id' => $data->id]) }}"
                                                        class="dropdown-item edit-item-btn"><i
                                                            class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                        اضافة تفاصيل الكورس</a></li>
                                                <li><a href="{{ route('courses_settings.show', ['id' => $data->id]) }}"
                                                        class="dropdown-item edit-item-btn"><i
                                                            class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                        تعديل</a></li>
                                        ...
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body text-center p-5">
                                                ...
                                                <div class="mt-4 pt-4">
                                                    ...
                                                    <form action="{{ route('courses_settings.destroy', 'test') }}"
                                                        method="post">
                                                        {{ method_field('delete') }}
                                                        {{ csrf_field() }}
