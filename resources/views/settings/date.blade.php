            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ trans('settings_trans.date_settings') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ trans('settings_trans.date_settings') }}</h5>
                    {{-- Message --}}
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('date_settings.update', 'test') }}"
                                        ...
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body text-center p-5">
                                                ...
                                                <div class="mt-4 pt-4">
                                                    ...
                                                    <form action="{{ route('date_settings.destroy', 'test') }}"
                                                        method="post">
                                                        {{ method_field('delete') }}
                                                        {{ csrf_field() }}
                                                        <input class="form-control" id="id" name="id"
    ...
    <div id="signupModals" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 overflow-hidden">
                ...
                <div class="modal-body">
                    <form action="{{ route('date_settings.store') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
