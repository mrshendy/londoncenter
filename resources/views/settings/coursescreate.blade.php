...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('courses_settings.store') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <select name="sections" class="form-control SlectBox" onclick="console.log($(this).val())"
                            onchange="myFunction();">
                            <!--placeholder-->
                            <option value="" selected disabled>{{ trans('settings_trans.sections_select') }}</option>
