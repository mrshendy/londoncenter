            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ URL::asset('assets/images/logo-sm.png') }}" alt="" height="17"
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button"
                        ...
                        <img id="header-lang-imgs"
                            @if (App::getlocale() == 'en') src="{{ URL::asset('assets/images/flags/us.svg') }}" @else src="{{ URL::asset('assets/images/flags/eg.svg') }}" @endif
                            alt="Header Language" height="20" class="rounded">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <li>
                                <a @if ($properties['native'] == 'English') hreflang="{{ $localeCode = 'en' }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode = 'en', null, [], true) }}" @else hreflang="{{ $localeCode = 'ar' }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode = 'ar', null, [], true) }}" @endif
                                    class="dropdown-item notify-item language py-2" rel="alternate"
                                    hreflang="{{ $localeCode }}"
                                    href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                    <img @if ($properties['native'] == 'English') src="{{ URL::asset('assets/images/flags/us.svg') }}" @else src="{{ URL::asset('assets/images/flags/eg.svg') }}" @endif
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}"class="me-3 rounded-circle avatar-xs"
                                                alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
