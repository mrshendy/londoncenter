        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">{{ trans('trans_website.View seminars_and_conferences details') }}
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white"
                                    href="{{ url('/' . ($page = 'home')) }}">{{ trans('trans_website.home') }}</a></li>
                            <li class="breadcrumb-item"><a class="text-white">{{ trans('trans_website.seminars_and_conferences') }}</a>
                            </li>
                            <li class="breadcrumb-item text-white active" aria-current="page">
                                {{ trans('trans_website.View seminars_and_conferences details') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="meeting-single-item">
                                ...
                                <div class="down-content">
                                    ...
                                    @endif
                                    @if ($courses->content!="<p>&nbsp;</p>" &&  $courses->introduction)
                                        <div>
                                            <div
                                                style="border-bottom: 2px solid var(--bs-secondary);align-items: center !important;justify-content: space-between !important;display: flex !important;box-sizing: border-box;margin-bottom: 10px;">
                                                <h3 style="font-size: 18px;padding: 10px;">
                                                    {{ trans('trans_website.descriptions') }}
                                                </h3>
                                            </div>
                                        </div>
                                        <div class="description">
